...
Once the `conda-forge` channel has been enabled, `httpx2` can be installed with `conda`:
...
It is possible to list all of the versions of `httpx2` available on your platform with `conda`:
